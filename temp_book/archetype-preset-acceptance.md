...
>
> 2026-04-24 补充：本验收只能证明三套 preset 的机制可用，不能单独证明玩家在正式 run 中一定能拿到这些牌/遗物。本轮已将旗帜牌接入角色奖励池与 Act 奖励分层，并将专属遗物接入角色遗物池、Boss 遗物池与商店遗物池；后续需要用正常 run 试玩验证真实体感。
...
- 先进行三局正式 run 人工试玩（burst / guard / mixed 各一局）验证主观手感与决策意图是否清晰。
