...
const ENCOUNTERS: EncounterTemplate[] = [
  ...
  { id: 'act1_normal_tax', chapter: 1, tier: 'normal', weight: 8, name: '拾荒抽税', tags: ['resource_tax', 'disruption'], pressureProfile: 'disruption', lineup: lineup(['slime_guard', 'slime']) },
  ...
  { id: 'act1_normal_reactive', chapter: 1, tier: 'normal', weight: 7, name: '反制泥沼', tags: ['reactive', 'attrition'], pressureProfile: 'attrition', lineup: lineup(['bone_crow', 'mire_toad']) },
